...
namespace WpfAsyncPack.Command
{
    public class SyncCommand : SyncCommand<object>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncCommand"/> class. This constructor doesn't set the <see cref="SyncCommand.ExecuteAction"/>
        /// and <see cref="SyncCommand.CanExecuteFunc"/>. They should be set manually in the derived class before the command is executed.
        /// </summary>
