...
{
    /// <summary>
    /// An asynchronous delegate command that supports cancellation and provides bindable detailed information about
    ...
    public class AsyncCommand : AsyncCommand<object>, IAsyncCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncCommand"/> class. This constructor doesn't set
        /// the <see cref="AsyncCommand.ExecuteFunc"/> and <see cref="AsyncCommand.CanExecuteFunc"/> functions.
